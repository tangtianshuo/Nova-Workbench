...
- [ ] **SESS-01**: sessions 元数据表落地(workspace_id/title/parent_session_id/fork_cut_seq/created_at/last_active_at),migration 0007 含历史会话幂等回填,fixture DB 升级测试保证旧数据不丢失、历史会话不消失
...
- [ ] **SESS-06**: agent_events 事件 scope 记录 workspaceId 并回填历史(列表过滤的数据基础)
