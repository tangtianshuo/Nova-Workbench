...
| 260813-u7m | Ollama 模型名可配置 + Settings 保存 key / 切 Ollama 时连通性验证 | 2026-08-13 | adbd0bb | [260813-u7m-ollama-my-ornith-llama3-2-settings-provi](./quick/260813-u7m-ollama-my-ornith-llama3-2-settings-provi/) |
