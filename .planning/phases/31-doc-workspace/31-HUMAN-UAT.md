...
- [ ] **SC-1.1** 打开右侧工作区面板,从文档列表打开一篇 AI 产出的知识文档(槽位流或 knowledge_write 归档流任一)
...
- [ ] **SC-2.1** 工作区新建一篇笔记(不选产品归属,doc_kind=note,product_id='__global__')
...
- [ ] **SC-6.3** 三处旧使用点(KnowledgeBaseView 编辑 / ProductKnowledgeTab / PrdDraftDialog)编辑器外观与工作区一致(同一组件)
